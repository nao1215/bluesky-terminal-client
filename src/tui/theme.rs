...
const fn palette(
    name: &'static str,
    [bg, fg, dim, accent, error, ok, like, repost]: [u32; 8],
) -> Theme {
    Theme {
        name,
        bg: rgb(bg),
...
pub static THEMES: [Theme; 42] = [
    palette(
        "bluesky",
        [
            0x161e27, 0xf1f3f5, 0x8b98a5, 0x1185fe, 0xff5c5c, 0x20bc07, 0xec4899, 0x20bc07,
        ],
    ),
    palette(
        "bluesky-dark",
        [
            0x000000, 0xffffff, 0x8b98a5, 0x1185fe, 0xff5c5c, 0x20bc07, 0xec4899, 0x20bc07,
        ],
    ),
    palette(
        "bluesky-light",
        [
            0xffffff, 0x0b0f14, 0x6e7d8c, 0x1185fe, 0xe0245e, 0x13a60b, 0xec4899, 0x13a60b,
        ],
    ),
    Theme {
        name: "terminal",
    ...
    palette(
        "ayu-dark",
        [
            0x0b0e14, 0xbfbdb6, 0x565b66, 0xe6b450, 0xd95757, 0x7fd962, 0xf07178, 0x95e6cb,
        ],
    ),
    palette(
        "ayu-light",
        [
            0xfcfcfc, 0x5c6166, 0x8a9199, 0xff9940, 0xe65050, 0x86b300, 0xf07171, 0x4cbf99,
        ],
    ),
    palette(
        "catppuccin-frappe",
        [
            0x303446, 0xc6d0f5, 0x838ba7, 0xca9ee6, 0xe78284, 0xa6d189, 0xf4b8e4, 0x81c8be,
        ],
    ),
    palette(
        "catppuccin-latte",
        [
            0xeff1f5, 0x4c4f69, 0x8c8fa1, 0x8839ef, 0xd20f39, 0x40a02b, 0xea76cb, 0x179299,
        ],
    ),
    palette(
        "catppuccin-macchiato",
        [
            0x24273a, 0xcad3f5, 0x8087a2, 0xc6a0f6, 0xed8796, 0xa6da95, 0xf5bde6, 0x8bd5ca,
        ],
    ),
    palette(
        "catppuccin-mocha",
        [
            0x1e1e2e, 0xcdd6f4, 0x7f849c, 0xcba6f7, 0xf38ba8, 0xa6e3a1, 0xf5c2e7, 0x94e2d5,
        ],
    ),
    palette(
        "cobalt2",
        [
            0x193549, 0xffffff, 0x8aa4b8, 0xffc600, 0xff628c, 0x3ad900, 0xff9d00, 0x2affdf,
        ],
    ),
    palette(
        "dracula",
        [
            0x282a36, 0xf8f8f2, 0x6272a4, 0xbd93f9, 0xff5555, 0x50fa7b, 0xff79c6, 0x50fa7b,
        ],
    ),
    palette(
        "everforest",
        [
            0x2d353b, 0xd3c6aa, 0x859289, 0xa7c080, 0xe67e80, 0xa7c080, 0xd699b6, 0x83c092,
        ],
    ),
    palette(
        "github-dark",
        [
            0x0d1117, 0xe6edf3, 0x7d8590, 0x2f81f7, 0xf85149, 0x3fb950, 0xdb61a2, 0x3fb950,
        ],
    ),
    palette(
        "github-light",
        [
            0xffffff, 0x1f2328, 0x656d76, 0x0969da, 0xcf222e, 0x1a7f37, 0xbf3989, 0x1a7f37,
        ],
    ),
    palette(
        "gruvbox",
        [
            0x282828, 0xebdbb2, 0x928374, 0xfabd2f, 0xfb4934, 0xb8bb26, 0xd3869b, 0x8ec07c,
        ],
    ),
    palette(
        "gruvbox-light",
        [
            0xfbf1c7, 0x3c3836, 0x928374, 0xb57614, 0x9d0006, 0x79740e, 0x8f3f71, 0x427b58,
        ],
    ),
    palette(
        "horizon",
        [
            0x1c1e26, 0xd5d8da, 0x6c6f93, 0x26bbd9, 0xe95678, 0x29d398, 0xee64ac, 0x59e3e3,
        ],
    ),
    palette(
        "iceberg",
        [
            0x161821, 0xc6c8d1, 0x6b7089, 0x84a0c6, 0xe27878, 0xb4be82, 0xa093c7, 0x89b8c2,
        ],
    ),
    palette(
        "kanagawa",
        [
            0x1f1f28, 0xdcd7ba, 0x727169, 0x7e9cd8, 0xe82424, 0x98bb6c, 0xd27e99, 0x7aa89f,
        ],
    ),
    palette(
        "material",
        [
            0x263238, 0xeeffff, 0x546e7a, 0x82aaff, 0xf07178, 0xc3e88d, 0xc792ea, 0x89ddff,
        ],
    ),
    palette(
        "monokai",
        [
            0x272822, 0xf8f8f2, 0x75715e, 0x66d9ef, 0xf92672, 0xa6e22e, 0xae81ff, 0xa6e22e,
        ],
    ),
    palette(
        "night-owl",
        [
            0x011627, 0xd6deeb, 0x637777, 0x82aaff, 0xef5350, 0x22da6e, 0xc792ea, 0x7fdbca,
        ],
    ),
    palette(
        "nightfox",
        [
            0x192330, 0xcdcecf, 0x738091, 0x719cd6, 0xc94f6d, 0x81b29a, 0x9d79d6, 0x63cdcf,
        ],
    ),
    palette(
        "nord",
        [
            0x2e3440, 0xeceff4, 0x7b88a1, 0x88c0d0, 0xbf616a, 0xa3be8c, 0xb48ead, 0xa3be8c,
        ],
    ),
    palette(
        "oceanic-next",
        [
            0x1b2b34, 0xd8dee9, 0x65737e, 0x6699cc, 0xec5f67, 0x99c794, 0xc594c5, 0x5fb3b3,
        ],
    ),
    palette(
        "one-dark",
        [
            0x282c34, 0xabb2bf, 0x5c6370, 0x61afef, 0xe06c75, 0x98c379, 0xc678dd, 0x56b6c2,
        ],
    ),
    palette(
        "one-light",
        [
            0xfafafa, 0x383a42, 0xa0a1a7, 0x4078f2, 0xe45649, 0x50a14f, 0xa626a4, 0x0184bc,
        ],
    ),
    palette(
        "palenight",
        [
            0x292d3e, 0xa6accd, 0x676e95, 0x82aaff, 0xff5370, 0xc3e88d, 0xc792ea, 0x89ddff,
        ],
    ),
    palette(
        "papercolor-light",
        [
            0xeeeeee, 0x444444, 0x878787, 0x005f87, 0xaf0000, 0x008700, 0xd7005f, 0x0087af,
        ],
    ),
    palette(
        "rose-pine",
        [
            0x191724, 0xe0def4, 0x6e6a86, 0xc4a7e7, 0xeb6f92, 0x9ccfd8, 0xebbcba, 0x9ccfd8,
        ],
    ),
    palette(
        "rose-pine-dawn",
        [
            0xfaf4ed, 0x575279, 0x9893a5, 0x907aa9, 0xb4637a, 0x286983, 0xd7827e, 0x56949f,
        ],
    ),
    palette(
        "rose-pine-moon",
        [
            0x232136, 0xe0def4, 0x6e6a86, 0xc4a7e7, 0xeb6f92, 0x9ccfd8, 0xea9a97, 0x9ccfd8,
        ],
    ),
    palette(
        "solarized",
        [
            0x002b36, 0x93a1a1, 0x657b83, 0x268bd2, 0xdc322f, 0x859900, 0xd33682, 0x2aa198,
        ],
    ),
    palette(
        "solarized-light",
        [
            0xfdf6e3, 0x586e75, 0x93a1a1, 0x268bd2, 0xdc322f, 0x859900, 0xd33682, 0x2aa198,
        ],
    ),
    palette(
        "synthwave-84",
        [
            0x262335, 0xffffff, 0x848bbd, 0xff7edb, 0xfe4450, 0x72f1b8, 0xff7edb, 0x36f9f6,
        ],
    ),
    palette(
        "tokyo-night",
        [
            0x1a1b26, 0xc0caf5, 0x737aa2, 0x7aa2f7, 0xf7768e, 0x9ece6a, 0xbb9af7, 0x73daca,
        ],
    ),
    palette(
        "tokyo-night-day",
        [
            0xe1e2e7, 0x3760bf, 0x848cb5, 0x2e7de9, 0xf52a65, 0x587539, 0x9854f1, 0x118c74,
        ],
    ),
    palette(
        "tokyo-night-storm",
        [
            0x24283b, 0xc0caf5, 0x737aa2, 0x7aa2f7, 0xf7768e, 0x9ece6a, 0xbb9af7, 0x73daca,
        ],
    ),
    palette(
        "tomorrow-night",
        [
            0x1d1f21, 0xc5c8c6, 0x969896, 0x81a2be, 0xcc6666, 0xb5bd68, 0xb294bb, 0x8abeb7,
        ],
    ),
    palette(
        "zenburn",
        [
            0x3f3f3f, 0xdcdccc, 0x7f9f7f, 0x8cd0d3, 0xcc9393, 0x9fc59f, 0xdc8cc3, 0x93e0e3,
        ],
    ),
    Theme {
        name: "monochrome",
...
mod tests {
    ...
    fn a_256_color_terminal_gets_no_24_bit_colors() {
        for t in &THEMES {
            ...
            for c in [t.bg, t.fg, t.dim, t.accent, t.error, t.ok, t.like, t.repost] {
